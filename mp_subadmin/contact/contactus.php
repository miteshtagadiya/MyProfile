...
?>
                                ...
                                <div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter contact no.1" name="contact1">
											</div>
										
											<div class="form-group">
                                            <label>Contact number2</label>
                                            <input type="text" class="form-control" placeholder="Enter contact no.2" name="contact2">
											</div>
        ...
        <script type="text/javascript"> 
            var map;
            var marker;
            var myLatlng = new google.maps.LatLng(21.206295,72.849320);
