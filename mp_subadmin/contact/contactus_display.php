...
$query="select * from mp_contactus where employee_id='$employeeid'";
                            ...
                            <div class="card-box" style="margin-top:50px;">
							 <h4 class="m-t-0 header-title" style="margin-bottom:30px;text-align:center;margin-top:20px !important;"><b>Contact US</b></h4>
								...
								<div class="form-group">
                                            ...
                                            <h3><b><?php echo $row['contactus_name']; ?></b></h3>
                                        </div>
									<div class="row">	
											<div class="col-sm-6">
												...
												<div class="form-group">
													<label>Address:</label>
													<?php echo $row['contactus_address']; ?>
												</div>  
												<div class="form-group">
													<label>Email Id:</label>
													<?php echo $row['contactus_emailid']; ?>
												</div>										
											</div>
											
											<?php if(empty($row['contactus_phone_1'])){?>
											<div class="form-group">
                                            <label>Contact number:</label>
                                            <?php echo $row['contactus_phone_2']; ?>
											</div>
											<?php } else if(empty($row['contactus_phone_2'])) { ?>
											<div class="form-group">
                                            <label>Contact number:</label>
                                            <?php echo $row['contactus_phone_1']; ?>
											</div>
											<?php } else { ?>
											<div class="form-group">
										...
										<div class="row">
										<div class="" style="background-color:#5D9CEC;border-radius:10px;margin :9px;padding : 1px;">
