...
$sqlproduct = "select * from product where vid = $vid";
...
<!-- Mirrored from nunforest.com/koncept/garden/default/projects-3col.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jun 2015 08:55:14 GMT -->
<head>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="drop"><a class="active" href="products.php?vid=<?php echo $vid;?>">Products</a>
