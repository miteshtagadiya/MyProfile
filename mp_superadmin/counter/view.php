...
$db_selected = mysql_select_db('myprofile');
...
// ######################
	...
	$query = "SELECT SUM(count)  AS totalhits FROM mp_tablehits"; 
...
// ####################
	...
	$result = mysql_query("SELECT * FROM mp_tablehits ORDER BY count DESC");
...
$result=mysql_query("SELECT MAX(info_id) FROM tableinfo");
