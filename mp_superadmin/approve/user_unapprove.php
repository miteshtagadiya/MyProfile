                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
								<?php $query="select * from mp_registration where isapprove='0'"; $data=mysqli_query($query); 
										...
										<td><a href="user_unapprove_update.php?id=<?php echo $rec['employee_id']; ?>">UnApprove</a></td>
                                    </tr>
