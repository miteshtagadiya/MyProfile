        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row" style="margin-bottom:20px; margin-top: 30px;">
                    <div class="col-sm-12">
                        <h4 class="page-title" style="text-align:center;">UnApproved Users </h4>
					</div>
				</div>
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
								<?php $query="select * from mp_registration where isapprove='0' and type='employee'"; $data=mysqli_query($con,$query); 
