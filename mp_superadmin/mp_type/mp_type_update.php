...
if(isset($_POST['submit']))
{
	...
	$query="update mp_type set type_name='$type' where type_id='$id'";
	if(mysqli_query($con,$query))
	{
		header("location:mp_type_display.php");
	}
	else{
		header("location:mp_type_update.php");
	}
	
}
$query="select * from mp_type where type_id='$id'";
							   ...
							   <div class="col-md-12" >
                                    <form class="form-horizontal" role="form" method="post">
										 <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter type" name="typename" value="<?php echo $rec[1]?>">
                                        </div>
